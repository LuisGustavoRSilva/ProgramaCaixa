...
#         #=================== Inicio do 2 ====================================
        ...
        self.label_direita2 = QLabel()

        # Criar o layout horizontal para a label 2 e a 
        # Line Edit
        self.layout_h_2 = QHBoxLayout()

        # Criar a label que terá o texto 2
        self.label_2 = QLabel("2")
        # Criar a LineEdit que recebe o total de desc
        self.edit_2 = QLineEdit("R$ 0,00")
        # adicionar a label_desc e a edit_desc ao layout horizontal desc
        self.layout_h_2.addWidget(self.label_2)
        self.layout_h_2.addWidget(self.edit_2)

        # Adiconar o layout_h_2 a label _2
        self.label_direita2.setLayout(self.layout_h_2)

        # adicionar a label_2 ao layout_v_esquerda
        self.layout_v_direita.addWidget(self.label_direita2)
...
# # =================== Fim do 2 =========================================
        ...
        #Label rodape
        self.label_rodape = QLabel("Selecione o Documento para emissão")
        texto_inferior.setAlignment(Qt.AlignCenter)
        layout_principal.addWidget(texto_inferior)
        self.layout_botoes = QHBoxLayout()

        self.label_botao = QPushButton("(ESC) Sair")

        self.layout_botoes.addWidget(self.label_botao)


        self.label_rodape.setLayout(self.layout_botoes)
        self.label_rodape.setStyleSheet("QLabel{background-color:green}")
        self.layout_v_total.addWidget(self.label_rodape)
        self.layout_v_total.addWidget(self.label_botao)
